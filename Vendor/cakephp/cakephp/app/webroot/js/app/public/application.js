...
var jade_debug = [ new jade.DebugItem( 1, "/Library/Server/Web/Data/Sites/ha-lehmann/Vendor/cakephp/cakephp/app/webroot/js/app/app/views/sample.jade" ) ];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (version) {
jade_debug.unshift(new jade.DebugItem( 0, "/Library/Server/Web/Data/Sites/ha-lehmann/Vendor/cakephp/cakephp/app/webroot/js/app/app/views/sample.jade" ));
jade_debug.unshift(new jade.DebugItem( 1, "/Library/Server/Web/Data/Sites/ha-lehmann/Vendor/cakephp/cakephp/app/webroot/js/app/app/views/sample.jade" ));
buf.push("<h2>");
...
buf.push("</h2>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 2, "/Library/Server/Web/Data/Sites/ha-lehmann/Vendor/cakephp/cakephp/app/webroot/js/app/app/views/sample.jade" ));
buf.push("<p>");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
