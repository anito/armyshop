...
elseif ( $_POST [ "parameter" ] == "$lang_admin_sc[13]" )
 {
  ...
  if ( ( decoct ( fileperms ( "config/tracking_code.ctp"          ) ) == 100666 ) || ( decoct ( fileperms ( "config/tracking_code.ctp"          ) ) == 100660 ) ) { echo '<tr><td style="border-bottom:1px solid #000000">config/tracking_code.ctp</td><td style="border-bottom:1px solid #000000">'.file_perms ( "config/tracking_code.ctp" ).'</td><td style="border-bottom:1px solid #000000"><img src="images/sysinfo_ok.png" style="vertical-align:middle" alt=""></td></tr>'; } else { echo '<tr><td style="border-bottom:1px solid #000000">config/tracking_code.ctp</td><td style="border-bottom:1px solid #000000">'.file_perms ( "config/tracking_code.ctp" ).'</td><td style="border-bottom:1px solid #000000"><img src="images/sysinfo_error.png" style="vertical-align:middle" alt=""></td></tr>'; }
